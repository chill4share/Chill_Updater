...
# Import các thành phần từ những module con
...
class MainApplication:
    ...
    # === CẢI TIẾN: Thêm cửa sổ tiến trình cho các tác vụ nền ===
    ...
    def _do_check_updates(self, silent=False, progress_win=None):
        """Thực hiện logic kiểm tra cập nhật trong một luồng riêng."""
        try:
            if not hasattr(sys, '_MEIPASS'):
                if not silent:
            ...
            latest_info_url = "https://raw.githubusercontent.com/chill4share/Chill_Updater/main/latest.json"
            ...
            # Luôn đóng cửa sổ chờ khi kết thúc
            if progress_win:
