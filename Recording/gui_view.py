...
class GUIView:
    ...
    def setup_ui(self):
        ...
        ttk.Label(header_frame, text="Thư mục lưu:").grid(row=0, column=0, sticky="w", padx=(0, 5))
        ...
        ttk.Button(header_frame, text="Duyệt...", command=self.controller.browse_output_dir).grid(row=0, column=2, padx=(5, 0))
        ...
        self.card_container = ttk.Frame(canvas) # Frame chính chứa các cặp thẻ
